...
public:
	...
	void add_arbitrary_info(string someatom_type,
							...
							int someresidue_iname,
							double xx_coordinate, double yy_coordinate, double zz_coordinate);
	void add_arbitrary_info(CAtom someatom, double ZOOMFACTOR);
	void readpdbinfo(const string atominfo);
...
public:
	...
	//void sort();
	void readpdbinfo_str(const string atominfo, double ZOOMFACTOR);
	void readpdbinfo(const char* fmolname, double ZOOMFACTOR, bool ifverbose);
